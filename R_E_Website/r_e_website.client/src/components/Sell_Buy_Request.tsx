...
function Sell_Buy_Request({ type }) {
    ...
    const [formData, setFormData] = useState({
        ...
        phoneNumber: '',
        additionalInfo: '',
        requestType: type === 'buy' ? RequestType.Buy : RequestType.Sell
    });
    ...
    async function postRequest() {
        ...
        const requestEstateData: RequestEstate = {
            estateType: formData.estateType,
            city: formData.city,
            district: formData.district,
            estateAddress: formData.estateAddress,
            roomCount: formData.roomCount,
            discription: formData.discription,
            priceUah: formData.priceUah,
            totalSquare: formData.totalSquare,
            livingSquare: formData.livingSquare,
            ...
            <form onSubmit={handleSubmit}>
                <div className="first-col">
                    ...
                    <div className="inputs">
                        <input type="text" className="bigger-input" placeholder="Ваше ім'я *" required
                            value={formData.clientName}
                            onChange={e => setFormData(request => ({ ...request, clientName: e.target.value }))} />
                        <input type="text" className="bigger-input" placeholder="Телефон +38()___ __ __ *" required
                            value={formData.phoneNumber}
                            onChange={e => setFormData(request => ({ ...request, phoneNumber: e.target.value }))} />
                        <input type="text" className="bigger-input" placeholder="Email"
                            value={formData.clientEmail}
                            onChange={e => setFormData(request => ({ ...request, clientEmail: e.target.value }))} />
                    </div>
                </div>
                ...
                <div className="sec-col">
                    ...
                    <div className="svg-container-s">
                        <div onClick={() => handleTypeSelection(EstateType.Flat)}>
                        ...
                        <div onClick={() => handleTypeSelection(EstateType.House)}>
                        ...
                        <div onClick={() => handleTypeSelection(EstateType.Land)}>
                        ...
                        <div onClick={() => handleTypeSelection(EstateType.Commerce)}>
                    ...
                    <div className="location-div">
                        ...
                        {type == 'sell' &&
                            <div className="inputs opened-i">
                                <input type="text" className="smaller-input" placeholder="Місто *" required
                                    value={formData.city}
                                    onChange={e => setFormData(request => ({ ...request, city: e.target.value }))}/>
                                <input type="text" className="smaller-input" placeholder="Район *" required
                                    value={formData.district}
                                    onChange={e => setFormData(request => ({ ...request, district: e.target.value }))}/>
                                <input type="text" className="smaller-input" placeholder="Адреса *" required
                                    value={formData.estateAddress}
                                    onChange={e => setFormData(request => ({ ...request, estateAddress: e.target.value }))}/>
                            </div>
                        }
                    ...
                    {selectedType == EstateType.Flat && <div className="search-item-s">
                        <div className="search-item-header-s">
                        ...
                        <div className="search-item-body-s rooms-container-s">
                            <div onClick={() => setFormData(request => ({ ...request, roomCount: 1 }))} style={{ backgroundColor: formData.roomCount == 1 ? '#a52722' : 'white', color: formData.roomCount == 1 ? 'white' : 'black' }}>1</div>
                            <div onClick={() => setFormData(request => ({ ...request, roomCount: 2 }))} style={{ backgroundColor: formData.roomCount == 2 ? '#a52722' : 'white', color: formData.roomCount == 2 ? 'white' : 'black' }}>2</div>
                            <div onClick={() => setFormData(request => ({ ...request, roomCount: 3 }))} style={{ backgroundColor: formData.roomCount == 3 ? '#a52722' : 'white', color: formData.roomCount == 3 ? 'white' : 'black' }}>3</div>
                            <div onClick={() => setFormData(request => ({ ...request, roomCount: 4 }))} style={{ backgroundColor: formData.roomCount == 4 ? '#a52722' : 'white', color: formData.roomCount == 4 ? 'white' : 'black' }}>4</div>
                            <div onClick={() => setFormData(request => ({ ...request, roomCount: 5 }))} style={{ backgroundColor: formData.roomCount == 5 ? '#a52722' : 'white', color: formData.roomCount == 5 ? 'white' : 'black' }}>5</div>
                        </div>

                    </div>}

                    {selectedType == EstateType.House && <div className="search-item-s">
                        <div className="search-item-header-s">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20.543" height="21" viewBox="0 0 20.543 21"><g transform="translate(-5.567)"><g transform="translate(11.045 0)"><g transform="translate(0)"><path className="a" d="M153.511,0h-13.7a.685.685,0,0,0-.685.685V14.838a.685.685,0,0,0,.685.685h13.7a.685.685,0,0,0,.685-.685V.686A.685.685,0,0,0,153.511,0Zm-.685,5.478h-2.054a.685.685,0,0,0,0,1.37h2.054v7.3h-8.674V12.1a.685.685,0,1,0-1.37,0v2.054H140.5V1.371h2.283V8.9a.685.685,0,1,0,1.37,0V6.849h3.424a.685.685,0,1,0,0-1.37h-3.424V1.371h8.674V5.479Z" transform="translate(-139.131 -0.001)"></path></g></g><g transform="translate(8.306 16.891)"><path className="a" d="M89.965,413.4,88.6,412.027a.685.685,0,1,0-.968.968l.2.2H74.7l.2-.2a.685.685,0,1,0-.968-.968L72.562,413.4a.686.686,0,0,0,0,.969l1.369,1.369a.685.685,0,0,0,.968-.968l-.2-.2H87.827l-.2.2a.685.685,0,0,0,.968.968l1.369-1.369A.686.686,0,0,0,89.965,413.4Z" transform="translate(-72.362 -411.826)"></path></g><g transform="translate(5.567)"><g transform="translate(0)"><path className="a" d="M8.506,14.353l-.2.2V2.338l.2.2a.685.685,0,1,0,.968-.968L8.105.2a.685.685,0,0,0-.968,0L5.767,1.57a.685.685,0,0,0,.968.968l.2-.2V14.553l-.2-.2a.685.685,0,0,0-.968.968l1.37,1.37a.685.685,0,0,0,.968,0l1.37-1.37a.685.685,0,1,0-.968-.968Z" transform="translate(-5.567 0)"></path></g></g></g></svg>
                            <p>Кімнат</p>
                        </div>
                    ...
                    <div className="add-info">
                        <div onClick={() => setDisplayAddInfo(!displayAddInfo)}>
                            <span>Додаткові дані</span>
                            <i className={displayAddInfo ? "ri-arrow-up-s-line" : "ri-arrow-down-s-line"}></i>
                        </div>

                        <div className={displayAddInfo ? "add-info-window visible" : "add-info-window"} >
                            <div className="search-item-header-s" style={{marginTop: 10}}>
                                <svg xmlns="http://www.w3.org/2000/svg" width="20.543" height="21" viewBox="0 0 20.543 21"><g transform="translate(-5.567)"><g transform="translate(11.045 0)"><g transform="translate(0)"><path className="a" d="M153.511,0h-13.7a.685.685,0,0,0-.685.685V14.838a.685.685,0,0,0,.685.685h13.7a.685.685,0,0,0,.685-.685V.686A.685.685,0,0,0,153.511,0Zm-.685,5.478h-2.054a.685.685,0,0,0,0,1.37h2.054v7.3h-8.674V12.1a.685.685,0,1,0-1.37,0v2.054H140.5V1.371h2.283V8.9a.685.685,0,1,0,1.37,0V6.849h3.424a.685.685,0,1,0,0-1.37h-3.424V1.371h8.674V5.479Z" transform="translate(-139.131 -0.001)"></path></g></g><g transform="translate(8.306 16.891)"><path className="a" d="M89.965,413.4,88.6,412.027a.685.685,0,1,0-.968.968l.2.2H74.7l.2-.2a.685.685,0,1,0-.968-.968L72.562,413.4a.686.686,0,0,0,0,.969l1.369,1.369a.685.685,0,0,0,.968-.968l-.2-.2H87.827l-.2.2a.685.685,0,0,0,.968.968l1.369-1.369A.686.686,0,0,0,89.965,413.4Z" transform="translate(-72.362 -411.826)"></path></g><g transform="translate(5.567)"><g transform="translate(0)"><path className="a" d="M8.506,14.353l-.2.2V2.338l.2.2a.685.685,0,1,0,.968-.968L8.105.2a.685.685,0,0,0-.968,0L5.767,1.57a.685.685,0,0,0,.968.968l.2-.2V14.553l-.2-.2a.685.685,0,0,0-.968.968l1.37,1.37a.685.685,0,0,0,.968,0l1.37-1.37a.685.685,0,1,0-.968-.968Z" transform="translate(-5.567 0)"></path></g></g></g></svg>
                                <p>Площа кв.м.</p>
                            </div>
                            <div className="inputs">
                                <input type="number" className="smaller-input" placeholder="загальна"
                                    value={formData.totalSquare == 0 ? 'загальна' : formData.totalSquare}
                                    onChange={e => setFormData(request => ({ ...request, totalSquare: parseInt(e.target.value) }))} />
                                <input type="text" className="smaller-input" placeholder="житлова"
                                    value={formData.livingSquare == 0 ? 'житлова' : formData.livingSquare}
                                    onChange={e => setFormData(request => ({ ...request, livingSquare: parseInt(e.target.value) }))} />
                                <input type="text" className="smaller-input" placeholder="кухні"
                                    value={formData.kitchenSquare == 0 ? 'кухні' : formData.kitchenSquare}
                                    onChange={e => setFormData(request => ({ ...request, kitchenSquare: parseInt(e.target.value) }))} />
                            </div>
                        </div>

                        <div className="pricing">
                            <div className="search-item-header-s" style={{ marginTop: 10 }}>
                                <svg xmlns="http://www.w3.org/2000/svg" width="23" height="23" viewBox="0 0 23 23"><g transform="translate(0)"><path className="a" d="M19.632,3.368A11.5,11.5,0,0,0,3.368,19.632,11.5,11.5,0,0,0,19.632,3.368ZM11.5,21.652A10.152,10.152,0,1,1,21.652,11.5,10.164,10.164,0,0,1,11.5,21.652Z" transform="translate(0)"></path></g><g transform="translate(7.939 4.331)"><path d="M181.017,102.9h-1.444a1.491,1.491,0,1,1,0-2.983h2.887a.674.674,0,1,0,0-1.348h-1.491V97.075a.674.674,0,1,0-1.348,0v1.491h-.048a2.839,2.839,0,1,0,0,5.678h1.444a1.491,1.491,0,0,1,0,2.983H178.13a.674.674,0,1,0,0,1.348h1.491v1.491a.674.674,0,1,0,1.348,0v-1.491h.048a2.839,2.839,0,0,0,0-5.678Z" transform="translate(-176.734 -96.401)"></path></g></svg>
                                <p>Ціна *</p>
                            </div>
                            <div className="inputs">
                                <input type="number" className="smaller-input" placeholder="$"
                                    value={formData.priceUah == 0 ? '$' : formData.priceUah}
                                    onChange={e => setFormData(request => ({ ...request, priceUah: parseInt(e.target.value) }))}/>
                            </div>
                        </div>
                ...
                <div className="third-col">
                    {type == 'sell' &&
                        <div className="opened">
                            <span>Опис об'єкта</span>
                            <textarea placeholder="Опис об'єкта"
                                value={formData.additionalInfo}
                                onChange={e => setFormData(request => ({ ...request, additionalInfo: e.target.value }))}/>
                        </div>
                    }
                    {type == 'buy' &&
                        <div className="opened">
                            <span>Додаткові параметри:</span>
                            <textarea placeholder="Додаткові параметри"
                                value={formData.additionalInfo}
                                onChange={e => setFormData(request => ({ ...request, additionalInfo: e.target.value }))}/>
                        </div>
                    }
...
export default Sell_Buy_Request;