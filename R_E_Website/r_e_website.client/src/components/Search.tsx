...
function Search({ onFilters, setSearchById }) {
    ...
    return (
        <form onSubmit={handleSubmit}>
            <div className="search-container-s" style={{
                gap: selectedType == EstateType.Flat || selectedType == EstateType.House ? '0' : '30px'
            }}>
                <div className={selectedType == EstateType.Flat || selectedType == EstateType.House
                    ? "search-item-s" : "search-item-s short-search"}>
